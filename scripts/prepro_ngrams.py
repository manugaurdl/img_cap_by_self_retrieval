...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default='/ssd_scratch/cvit/manu/img_cap_self_retrieval_clip/annotations/dataset_coco.json', help='input json file to process into hdf5')
    parser.add_argument('--dict_json', default='/ssd_scratch/cvit/manu/img_cap_self_retrieval_clip/data/cocotalk.json', help='output json file')
